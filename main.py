...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Junaidkhan012/comma.git/test/blob/main/a.txt"])
	exit(" [*] FACEBOOK :  https://m.me/nadia.sheikh.9277583")
...
def notice():
	...
	subprocess.check_output(["am", "start", "https://github.com/Junaidkhan012/log.git"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Junaidkhan012/log.git/blob/main/a.txt').text
			if basesplit in plr:
				key = basesplit
